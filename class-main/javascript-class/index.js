...
if (s + d == c) {
  ...
  addNumbers();
  document.write(addNumbers() + linebreak);
  // document.write("the addition is true" + linebreak);
} else if  (s + d > c) {
  document.write("the addition is greater than c" + linebreak);

} else if (s + d < c) {
  document.write("the addition is less than c" + linebreak);
} else {
  document.write("Ayo" + linebreak);
}
...
// while (1 < 100) {
//     1+= 1;
//    console.log("This is a loop" + "<br />");
    // document.write("This is a loop" + "<br />");
    // break; // To prevent an infinite loop, we break out of it immediately
